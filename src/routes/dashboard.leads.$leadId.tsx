...
import {
  ...
  Star, ExternalLink, AlertTriangle, Sparkles, ListChecks, Smartphone, Globe2, FileText, Send,
  Briefcase, FileSignature, Users, Gauge, Lightbulb, CheckCircle2, XCircle, ArrowLeftRight,
} from "lucide-react";
...
import {
  cap, Section, StatBlock, FactTile, YesNoTile, KVRow, Pill, FactBlock, VoteRow, DraftCard,
} from "@/components/dashboard/lead-detail/tiles";
