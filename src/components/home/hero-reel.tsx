...
const REEL_LEADS: Lead[] = [
  ...
  { title: "Looking for SEO help for my clinic in London", platform: "LinkedIn", country: "UK", flag: "🇬🇧", ago: "38s" },
...
export function HeroReel() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#080808] shadow-[0_40px_120px_-30px_rgba(0,0,0,0.9)]">
      {/* window chrome */}
