...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    slug: "local-seo-checklist-for-small-agencies",
    title: "The 12-point local SEO checklist we run for every new client",
    excerpt:
      "A practical local SEO checklist you can run in an afternoon — Google Business Profile, citations, on-page basics and review velocity.",
    category: "SEO",
    tags: ["Local SEO", "Google Business Profile", "Citations"],
    author: { name: "Maya Chen", role: "SEO consultant", avatar: av(32) },
    date: "2026-05-12",
    readMinutes: 6,
    cover: cover("1432888498266-38ffec3eaf0a"),
    body: [
      { type: "p", text: "Local SEO doesn't need a 60-page audit. Most local businesses are missing the same 12 basics — fix those first." },
      { type: "h2", text: "Start with Google Business Profile" },
      { type: "list", items: ["Verified and fully filled out", "Primary category matches the main service", "Photos updated in the last 30 days", "Q&A section with real answers", "Reviews from the last 90 days"] },
      { type: "h2", text: "Then fix on-page" },
      { type: "p", text: "City + service in the title tag. NAP in the footer. Embedded map on the contact page. Done. You'll outrank 80% of competitors in most local markets just by doing this." },
    ],
  },
  {
